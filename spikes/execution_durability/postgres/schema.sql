...
CREATE TABLE IF NOT EXISTS execution_aggregates (
    ...
    command_terminal BOOLEAN NOT NULL,
    aggregate_terminal BOOLEAN NOT NULL,
...
-- PostgreSQL CAS statement prototype:
-- UPDATE execution_aggregates
-- SET execution_revision = $3, lifecycle_state = $4, updated_at = $5
-- WHERE aggregate_id = $1 AND execution_revision = $2;

-- PostgreSQL row-locking prototype for command intake:
-- SELECT aggregate_id, execution_revision FROM execution_aggregates
